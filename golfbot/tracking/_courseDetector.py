...
class CourseDetector:
    ...
    def __find_box_corners_by_hough(self, img_bgr):
        ...
        # padding the corners, to get a bit outside the arena as well

        if tr is None or tl is None or br is None or bl is None:
            return None
