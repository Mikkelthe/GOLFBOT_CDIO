...
class Pathfinder:
    ...
    def __segment_near_polygon_bounds(
        ...
        min_x, max_x, min_y, max_y = Pathfinder.__polygon_bounds(polygon)
        segment_min_x = float(min(start.x, end.x)) - padding
        segment_max_x = float(max(start.x, end.x)) + padding
        segment_min_y = float(min(start.y, end.y)) - padding
        segment_max_y = float(max(start.y, end.y)) + padding
    ...
    def __make_search_bounds(
        ...
        min_x = floor((float(min(start.x, target.x)) - padding_cm) / grid_size_cm) * grid_size_cm
        max_x = ceil((float(max(start.x, target.x)) + padding_cm) / grid_size_cm) * grid_size_cm
        min_y = floor((float(min(start.y, target.y)) - padding_cm) / grid_size_cm) * grid_size_cm
        max_y = ceil((float(max(start.y, target.y)) + padding_cm) / grid_size_cm) * grid_size_cm
